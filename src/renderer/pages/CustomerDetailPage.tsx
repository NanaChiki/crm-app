 ...
 * タブ3: メンテナンス現場表（MaintenanceSiteList.tsx）- メンテナンス時期を迎えた現場の一覧
 *
 * 【50代配慮】
 * - 大きなタブボタン（最小48px高）
 * - 明確なアイコン・ラベル
...
import { MaintenanceSiteList } from '../components/maintenance/MaintenanceSiteList';
...
/** タブ識別子 */
type TabValue = 'info' | 'history' | 'sites';
...
export const CustomerDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (hash && ['info', 'history', 'sites'].includes(hash)) {
      setPageState((prev) => ({
        ...prev,
